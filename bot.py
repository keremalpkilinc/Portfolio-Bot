...
@bot.command(name='start') # !start ile Bot Kendisini Tanıtır
...
@bot.command(name='info') # !info Komutları Sıralar
async def info(ctx):
    await ctx.send("""
...
@bot.command(name='new_project') # Yeni Proje Eklememizi Sağlar 
...
@bot.command(name='projects') # !project Kaydedilmiş Projeleri Gösterir
...
@bot.command(name='skills') # !skills Projeye Beceri Eklememizi Sağlar
...
@bot.command(name='delete') # !delete Projeyi Silmemizi Sağlar
...
@bot.command(name='update_projects') # !update project Projeyi Güncellemeyi Sağlar
